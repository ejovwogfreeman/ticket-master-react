        ...
        <div className="max-w-7xl mx-auto px-4 flex justify-between items-center h-10">
          ...
          <div className="flex items-center space-x-2">
            <svg
              ...
              height="1.5em"
              aria-hidden="true"
              className="sc-fc75cc60-5 lbOkgz"
            >
              <path
                fill="#FFF"
      ...
      <div className="bg-blue-600 text-white relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center h-16">
          ...
          <nav className="hidden md:flex space-x-6 font-medium items-center">
            {navItems.map((item) => (
              <a key={item} className="hover:text-blue-200 cursor-pointer">
                {item}
              </a>
            ))}
          </nav>
        ...
        {/* Mobile Menu */}
        {menuOpen && (
          <div className="md:hidden absolute top-full left-0 w-full bg-blue-600 text-white z-40 shadow-lg">
            <div className="px-4 py-4 flex flex-col space-y-4">
              ...
              <button
                className="flex items-center space-x-2 bg-blue-800 px-4 py-2 rounded hover:bg-blue-900"
                onClick={() => setMenuOpen(false)}
              >
                <User size={20} />
